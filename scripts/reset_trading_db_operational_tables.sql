...
DROP TABLE IF EXISTS congress_price_cache;
DROP TABLE IF EXISTS congress_cleaning_issues;
DROP TABLE IF EXISTS congress_transactions;
DROP TABLE IF EXISTS congress_filings;
DROP TABLE IF EXISTS congress_scrape_runs;
...
CREATE TABLE IF NOT EXISTS agent_decisions (
  ...
  agent_name TEXT NOT NULL CHECK (agent_name IN ('ORACLE', 'SENTIMENT', 'PROFILER', 'CROUPIER', 'PIT_BOSS', 'HEDGE', 'JANITOR', 'EXECUTIONER', 'MOLTWORKER', 'RISK', 'SYSTEM')),
  target_agent TEXT CHECK (target_agent IN ('ORACLE', 'SENTIMENT', 'PROFILER', 'CROUPIER', 'PIT_BOSS', 'HEDGE', 'JANITOR', 'EXECUTIONER', 'MOLTWORKER', 'RISK', 'SYSTEM')),
